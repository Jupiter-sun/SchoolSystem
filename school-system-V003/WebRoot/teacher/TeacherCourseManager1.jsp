									...
									<table class="table table-bordered table-condensed">
										...
										<tbody>
											<s:iterator value="gradeCoursePoints" var="gcp" status="s">
												<tr>
													<td><input name="gradeCoursePoints[<s:property value="#s.index"/>].course.cursId" value="<s:property value="#gcp.course.cursId"/>" style="display:hidden"/><s:property value="#gcp.course.cursName"/></td>
