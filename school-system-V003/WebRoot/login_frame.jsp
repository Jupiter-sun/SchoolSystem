				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab1">
						<div class="div-major-inf">
							...
							<p class="major-inf-content">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本专业所属的学科基础厚重，现拥有机械工程一级学科好的博士后科研流动站和机械制造及其自动化、机械
					...
					<div class="tab-pane" id="tab3">
						<div class="div-major-inf">
							<h5>机械设计制造及其自动化专业毕业生应修满173+22个学分。</h5>
			...
			<div class="row">
				<div class="span8 offset3" id="loginDiv">
					...
					<form class="form-horizontal" id="loginForm" name="loginForm"
						...
						<div class="control-group">
							<label class="lable-identy"><input name="identity"
								type="radio" value="teacher" />教师 </label> <label class="lable-identy"><input
								name="identity" type="radio" value="student" checked="checked" />学生
							</label>
						</div>
						<div class="control-group">
							<div class="controls">
