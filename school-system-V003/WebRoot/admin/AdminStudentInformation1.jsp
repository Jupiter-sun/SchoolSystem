...
<script type="text/javascript">
	...
	function getItemId(label) {
		var itemId = label.parentNode.lastChild.innerHTML;
							...
							<tbody>
								<s:iterator value="items" var="i">
									<tr>
										...
										<td><label class="lable-add" data-toggle="modal"
											data-target="#myModal" onclick="getItemId(this)">审核</label> <label
											id="itemId" class="hidden"><s:property
													value="#i.itemNum" /></label></td>
									</tr>
								</s:iterator>
							</tbody>
						</table>
								...
								<form action="AdminStudent_Information_1_judgeStuItem"
									...
									<div class="control-group">
										...
										<div>
											...
											<input type="text" class="hidden" name="item.itemNum"
												id="input-itemId">
										</div>
									</div>
									<div class="div-btn">
